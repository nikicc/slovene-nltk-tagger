...
#uText = u'Tistega (veæera) sem-preveè "popil", zgodilo se je mesec dni po tem, ko sem izvedel, da me žena vara.'
uText = u'Živé naj vsi naródi, ki hrepené doèakat dan, da, koder sonce hodi, prepir iz svéta bo pregnan, ko rojak prost bo vsak, ne vrag, le sosed bo mejak.'
#uText = u'22-letni prof. Janez je preveè "popil" (za €3.12), ko ga žena vara. Zadel je 100.000.000€ žena vara! Nato je.... '
